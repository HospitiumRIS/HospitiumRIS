    ...
    <>
      ...
      <Container maxWidth="xl" sx={{ py: 4 }}>
        ...
        <Box sx={{ display: 'flex', gap: 2.5, mb: 3, flexWrap: 'wrap' }}>
          <StatCard label="Total Manuscripts" value={stats.total} color="#8b6cbc" />
          <StatCard label="Draft / Ongoing" value={stats.draft} sub="Active writing" color="#f59e0b" />
          <StatCard label="In Review / Revision" value={stats.inReview} sub="Awaiting feedback" color="#3b82f6" />
          <StatCard label="Published" value={stats.published} sub="Completed" color="#10b981" />
        </Box>
