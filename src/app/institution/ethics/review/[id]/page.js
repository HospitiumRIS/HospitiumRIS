...
export default function InstitutionEthicsReviewViewPage() {
  ...
  const handleReview = () => {
    router.push(`/institution/ethics/review/${params.id}/review`);
  };
  ...
  if (loading) {
    return (
      <Box>
        <PageHeader
          title="Ethics Application Review"
          description="Review ethics application details"
  ...
  return (
    <Box>
      <PageHeader
        ...
        description="Ethics Application Review"
        icon={<EthicsIcon sx={{ fontSize: 32 }} />}
        breadcrumbs={[
          { label: 'Home', icon: <HomeIcon sx={{ fontSize: 16 }} />, path: '/institution' },
          { label: 'Ethics Review', path: '/institution/ethics/review' },
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                ...
                {application.documents && application.documents.length > 0 ? (
                  <List sx={{ bgcolor: 'rgba(139, 108, 188, 0.02)', borderRadius: 2, p: 2 }}>
                    {application.documents.map((doc, index) => (
                      <ListItem
                        ...
                        secondaryAction={
                          <IconButton edge="end" sx={{ color: '#8b6cbc' }}>
                            <DownloadIcon />
                          </IconButton>
                        }
                      >
                  ...
                  <Box sx={{ 
                    ...
                    bgcolor: 'rgba(139, 108, 188, 0.02)',
                    borderRadius: 2,
                    border: '2px dashed rgba(139, 108, 188, 0.2)'
                  }}>
                    <AttachFileIcon sx={{ fontSize: 48, color: '#8b6cbc', opacity: 0.5, mb: 2 }} />
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                      ...
                      <Paper key={index} sx={{ 
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', mb: 2 }}>
                          ...
                          <Chip
                            ...
                            sx={{
                              bgcolor: statusColors[review.decision] || '#8b6cbc',
                              color: 'white',
                              fontWeight: 600,
                            }}
                          />
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                          {review.overallComments && (
                            <Box>
                              <Typography variant="subtitle2" sx={{ fontWeight: 600, color: '#718096', mb: 1 }}>
                                Overall Comments
                              </Typography>
                ...
                {application.linkedProposals && application.linkedProposals.length > 0 && (
                  <Box sx={{ mt: 3 }}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                      {application.linkedProposals.map((link, index) => (
                        <Paper key={index} sx={{ 
                          p: 2, 
                          borderRadius: 1,
                          border: '1px solid rgba(0, 0, 0, 0.08)',
                          ...
                          <Box sx={{ flex: 1 }}>
                            <Typography variant="body1" sx={{ fontWeight: 600, color: '#2D3748' }}>
                              {link.proposal?.title || 'Linked Proposal'}
                            </Typography>
